...
pub fn total_encoded_len<IntoIter, Item>(segments: IntoIter, version: Version) -> usize
where
    IntoIter: IntoIterator<Item = Item>,
    Item: std::borrow::Borrow<Segment>,
{
    segments
        .into_iter()
...
mod bench {
    ...
    fn bench_optimize_base64(bencher: &mut test::Bencher) {
        bench_optimize(crate::bench::BASE64_EXAMPLE, Version::Normal(40), bencher);
    }
}
